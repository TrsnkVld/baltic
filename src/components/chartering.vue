<template>
<main class="chartering">
	<header-title  :headerTitle="headerTitle" :headerDesc="headerDesc" />
    <chartering-services data-aos="fade-right"/>
	<section class="info">
		<b-container fluid>
			<img-txt-row
				:listText="text"
...
export default {
    ...
    data: () => ({
        headerTitle: 'Фрахтование',
        headerDesc: 'Мы предоставляем полный спектр услуг по фрахтованию судов',
		text: [
